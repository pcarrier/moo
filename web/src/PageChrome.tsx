...
export function ActionRow(props: { class?: string; children: JSX.Element; ariaLabel?: string }) {
  return <div class={joinClasses("action-row", props.class)} aria-label={props.ariaLabel}>{props.children}</div>;
}

export function InlineActions(props: { class?: string; children: JSX.Element; ariaLabel?: string }) {
  return <div class={joinClasses("inline-actions", props.class)} aria-label={props.ariaLabel}>{props.children}</div>;
}
...
export function ActionButton(props: JSX.ButtonHTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    <button type={local.type || "button"} class={joinClasses("action-button", local.class)} {...rest}>
      {local.children}
    </button>
  );
}

export function DetailSection(props: { class?: string; title?: JSX.Element; children: JSX.Element }) {
  return (
    <section class={joinClasses("detail-section", props.class)}>
