...
import {
  ...
  runTsToolCommand,
  runTsBackgroundCommand,
  runTsCancelCommand,
  runTsBackgroundsCommand,
...
const STEP_COMMANDS: Record<string, CommandHandler> = {
  ...
  "run-ts-tool": runTsToolCommand,
  "run-ts-background": runTsBackgroundCommand,
  "run-ts-cancel": runTsCancelCommand,
  "run-ts-backgrounds": () => runTsBackgroundsCommand(),
