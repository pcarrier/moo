  ...
  kimi: {
    ...
    models: [
      ...
      },
      {
        ...
        match: "^kimi-k2(?:-turbo-preview|-0905-preview|-0711-preview)?(?:[-.]|$)",
        availability: "Deprecated; use kimi-k2.6",
      },
      {
        id: "kimi-k2-thinking",
      ...
      { id: "moonshot-v1-auto", match: "^moonshot-v1-auto(?:[-.]|$)", contextWindow: 131_072, capabilities: { toolCalls: true }, defaultOption: true },
