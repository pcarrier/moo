...
export const PROVIDER_METADATA: Record<ProviderName, ProviderMetadata> = {
  ...
  anthropic: {
    ...
    models: [
      ...
      { id: "claude-opus-4-7", match: "^claude-opus-4[.-]7(?:[.-]|$)", contextWindow: 1_000_000, pricing: { input: 5, cachedInput: 0.5, cacheWriteInput: 6.25, output: 25 }, capabilities: { toolCalls: true }, defaultOption: true },
