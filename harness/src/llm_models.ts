...
export const PROVIDER_METADATA: Record<ProviderName, ProviderMetadata> = {
  ...
  anthropic: {
    ...
    models: [
      { id: "claude-opus-4", match: "^claude-opus-4(?:[.-]|$)", contextWindow: 200_000, pricing: { input: 15, cachedInput: 1.5, cacheWriteInput: 18.75, output: 75 }, capabilities: { toolCalls: true } },
      { id: "claude-sonnet-4", match: "^claude-sonnet-4(?:[.-]|$)", contextWindow: 200_000, pricing: { input: 3, cachedInput: 0.3, cacheWriteInput: 3.75, output: 15 }, capabilities: { toolCalls: true } },
      { id: "claude-haiku-4", match: "^claude-haiku-4(?:[.-]|$)", contextWindow: 200_000, pricing: { input: 1, cachedInput: 0.1, cacheWriteInput: 1.25, output: 5 }, capabilities: { toolCalls: true } },
      { id: "claude-opus-4-7", match: "^claude-opus-4[.-]7(?:[.-]|$)", contextWindow: 1_000_000, pricing: { input: 15, cachedInput: 1.5, cacheWriteInput: 18.75, output: 75 }, capabilities: { toolCalls: true }, defaultOption: true },
      { id: "claude-opus-4-6", defaultOption: true },
      { id: "claude-sonnet-4-6", defaultOption: true },
      { id: "claude-opus-4-5", defaultOption: true },
      { id: "claude-sonnet-4-5", defaultOption: true },
      { id: "claude-haiku-4-5", defaultOption: true },
      { id: "claude-opus-4-1", defaultOption: true },
